...
function cakes(recipe, available) {
    // divide availble values by their recipe counterparts
    // check if the ingredient even exists 
    ...
    for(let item in recipe) {
       ...
       let divide = Math.floor(available[item] / recipe[item])
       dividedNums.push(divide)
    }
    return Math.min(...dividedNums)
  }
